...
declare type ExtractRequestBody<T> = "requestBody" extends keyof T ? "application/json" extends keyof T["requestBody"] ? T["requestBody"]["application/json"] : {
    data: {
...
declare type SuccessStatusesMap = {
    "200": 200;
    "201": 201;
    "204": 204;
};
declare type RedirectStatusesMap = {
    "301": 301;
    "302": 302;
};
declare type SuccessStatuses = keyof SuccessStatusesMap;
declare type RedirectStatuses = keyof RedirectStatusesMap;
declare type KnownJsonResponseTypes = "application/json" | "application/scim+json";
declare type SuccessResponseDataType<Responses> = {
    [K in SuccessStatuses & keyof Responses]: OctokitResponse<DataType<Responses[K]> extends never ? unknown : DataType<Responses[K]>, SuccessStatusesMap[K]>;
}[SuccessStatuses & keyof Responses];
declare type RedirectResponseDataType<Responses> = {
    [K in RedirectStatuses & keyof Responses]: OctokitResponse<unknown, RedirectStatusesMap[K]>;
...
declare type ExtractOctokitResponse<R> = "responses" extends keyof R ? SuccessResponseDataType<R["responses"]> extends never ? RedirectResponseDataType<R["responses"]> extends never ? never : RedirectResponseDataType<R["responses"]> : SuccessResponseDataType<R["responses"]> : unknown;
